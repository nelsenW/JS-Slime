...
export default class Level {
    constructor(ctx, canvas){
        ...
        new ColorPad (this.ctx, this.canvas, "yellow", [this.canvas.width * 4/8, this.canvas.height * 0.9], this.level),
        new ColorPad (this.ctx, this.canvas, "yellow", [this.canvas.width * 5/8, this.canvas.height * 0.9], this.level),
